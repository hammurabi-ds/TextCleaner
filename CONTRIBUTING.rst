...
Welcome to ``txtclnr`` contributor's guide.
...
If you experience bugs or general issues with ``txtclnr``, please have a look
...
You can help improve ``txtclnr`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``txtclnr`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``txtclnr``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/txtclnr.git
    cd txtclnr
...
#. Install |pre-commit|_::
   ...
   ``txtclnr`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/txtclnr
.. _issue tracker: https://github.com/<USERNAME>/txtclnr/issues
.. <-- end -->
